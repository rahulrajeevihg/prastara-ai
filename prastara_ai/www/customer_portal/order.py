...
import frappe
from prastara_ai.api.customer_portal import _require_portal_session, _fetch_order_detail
...
def get_context(context):
	...
	try:
		doc = _fetch_order_detail(order_name, customer_name)
	...
	context.title = f"Order {order_name}"
