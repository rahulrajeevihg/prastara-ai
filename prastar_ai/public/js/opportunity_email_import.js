...
function pei_run_analysis(dialog, state) {
	...
	frappe.call({
		method: "prastar_ai.api.opportunity_email_import.analyze_email_screenshots",
...
function pei_create_opportunity(dialog, state) {
	...
	frappe.call({
		method: "prastar_ai.api.opportunity_email_import.create_opportunity_from_email_import",
		args: {
